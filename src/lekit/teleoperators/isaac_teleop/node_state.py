...
def create_monitor_app(state: TeleopNodeState) -> FastAPI:
    ...
    html = asset_directory.joinpath("teleop_node_monitor.html").read_text(encoding="utf-8")
    ...
    def monitor_script() -> FileResponse:
        return FileResponse(
            asset_directory / "teleop_node_monitor.js",
    ...
    def monitor_trajectory_script() -> FileResponse:
        return FileResponse(
            asset_directory / "teleop_node_monitor_trajectory.js",
            media_type="text/javascript",
        )
    ...
    def three_module() -> FileResponse:
        return FileResponse(
            asset_directory / "three.module.min.js",
            media_type="text/javascript",
        )
    ...
    def three_core_module() -> FileResponse:
        return FileResponse(
            asset_directory / "three.core.min.js",
            media_type="text/javascript",
        )
    ...
    def three_license() -> FileResponse:
        return FileResponse(
            asset_directory / "three.LICENSE.txt",
