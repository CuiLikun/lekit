...
_TRACE_FIELDS = (
    ...
    *(f"servo_commanded_{axis}" for axis in _EEF_AXES),
    "rerun_enqueued_frames",
    "rerun_processed_frames",
    "rerun_dropped_frames",
    "rerun_queue_depth",
    "rerun_worker_rate_hz",
    "rerun_log_ms",
    "rerun_image_ms",
    "rerun_curve_ms",
    "rerun_in_flight",
...
class ControlTraceWriter:
    ...
    def write_frame(
        ...
        *,
        ...
        rerun_status: Mapping[str, Any] | None = None,
        ...
        row: dict[str, object] = {
            ...
            "thumbstick_x": _number(telemetry.get("thumbstick_x")),
            "thumbstick_y": _number(telemetry.get("thumbstick_y")),
            "thumbstick_click": _number(telemetry.get("thumbstick_click")),
            "frame_ms": frame_ms,
            "control_rate_hz": control_rate_hz,
            "control_target_hz": control_target_hz,
            "observation_ms": (stage_timings or {}).get("observation_ms"),
            "camera_timeout": (stage_timings or {}).get("camera_timeout"),
            "camera_timeout_count": (stage_timings or {}).get("camera_timeout_count"),
            "device_compute_ms": (stage_timings or {}).get("device_compute_ms"),
            "send_action_ms": (stage_timings or {}).get("send_action_ms"),
            "dataset_ms": (stage_timings or {}).get("dataset_ms"),
            "rerun_enqueue_ms": (stage_timings or {}).get("rerun_enqueue_ms"),
            "grip_x_m": grip_pos[0],
            "grip_y_m": grip_pos[1],
            "grip_z_m": grip_pos[2],
            ...
            "servo_worker_mode": servo_status.get("worker_mode"),
            ...
            "rerun_enqueued_frames": (rerun_status or {}).get("enqueued_frames"),
            "rerun_processed_frames": (rerun_status or {}).get("processed_frames"),
            "rerun_dropped_frames": (rerun_status or {}).get("dropped_frames"),
            "rerun_queue_depth": (rerun_status or {}).get("queue_depth"),
            "rerun_worker_rate_hz": (rerun_status or {}).get("worker_rate_hz"),
            "rerun_log_ms": (rerun_status or {}).get("log_ms"),
            "rerun_image_ms": (rerun_status or {}).get("image_ms"),
            "rerun_curve_ms": (rerun_status or {}).get("curve_ms"),
            "rerun_in_flight": (rerun_status or {}).get("in_flight"),
            "rerun_in_flight_ms": (rerun_status or {}).get("in_flight_ms"),
            "rerun_worker_alive": (rerun_status or {}).get("worker_alive"),
            "rerun_errors": (rerun_status or {}).get("errors"),
        }
